...
-module(state_channel_client_pb).
...
-include("state_channel_client_pb.hrl").
...
-export_type(['helium.blockchain_state_channel_state_v1'/0, 'packet_pb.packet_type'/0, 'helium.region'/0]).
    ...
    B4 = if F4 == undefined -> B3;
		...
		begin
		  ...
		  if TrF4 =:= 'US915'; TrF4 =:= 0 -> B3;
		     true ->
			 'e_enum_helium.region'(TrF4, <<B3/binary, 32>>,
						TrUserData)
		  end
		end
	 end,
    ...
    B7 = if F7 == undefined -> B6;
		...
		begin
		  ...
		  if TrF7 =:= 'US915'; TrF7 =:= 0 -> B6;
		     true ->
			 'e_enum_helium.region'(TrF7, <<B6/binary, 56>>,
						TrUserData)
		  end
		end
	 end,
...
encode_msg_packet_pb(#packet_pb{oui = F1, type = F2,
    ...
    B2 = if F2 == undefined -> B1;
		...
		begin
		  ...
		  if TrF2 =:= longfi; TrF2 =:= 0 -> B1;
		     true ->
			 'e_enum_packet_pb.packet_type'(TrF2, <<B1/binary, 16>>,
							TrUserData)
		  end
		end
	 end,
    ...
    B9 = if F9 == undefined -> B8;
		...
		begin
		  ...
		  if TrF9 =:= undefined -> B8;
		     true ->
			 e_mfield_packet_pb_routing(TrF9, <<B8/binary, 74>>,
						    TrUserData)
		  end
		end
	 end,
    if F10 == undefined -> B9;
	   ...
	   begin
		...
		true ->
		    e_mfield_packet_pb_rx2_window(TrF10, <<B9/binary, 82>>,
						  TrUserData)
	     end
	   end
    end.
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_varint_blockchain_state_channel_summary_v1_pb(Rest,
								   ...
								   TrUserData);
	    1 ->
		skip_64_blockchain_state_channel_summary_v1_pb(Rest, 0,
							       0, F@_1, F@_2,
							       F@_3,
							       TrUserData);
	    2 ->
		...
		skip_group_blockchain_state_channel_summary_v1_pb(Rest,
								  ...
								  TrUserData);
	    5 ->
		skip_32_blockchain_state_channel_summary_v1_pb(Rest, 0,
							       0, F@_1, F@_2,
							       F@_3, TrUserData)
	  end
    end;
...
dfp_read_field_def_blockchain_state_channel_v1_pb(<<10,
    ...
    d_field_blockchain_state_channel_v1_pb_id(Rest, Z1, Z2,
...
dfp_read_field_def_blockchain_state_channel_v1_pb(<<18,
						  ...
						  F@_4, F@_5, F@_6, F@_7, F@_8,
						  F@_9, F@_10, TrUserData) ->
    d_field_blockchain_state_channel_v1_pb_owner(Rest, Z1,
...
dfp_read_field_def_blockchain_state_channel_v1_pb(<<24,
						  ...
						  F@_4, F@_5, F@_6, F@_7, F@_8,
						  F@_9, F@_10, TrUserData) ->
    d_field_blockchain_state_channel_v1_pb_credits(Rest, Z1,
						   Z2, F@_1, F@_2, F@_3, F@_4,
						   F@_5, F@_6, F@_7, F@_8, F@_9,
						   F@_10, TrUserData);
dfp_read_field_def_blockchain_state_channel_v1_pb(<<32,
						  ...
						  F@_4, F@_5, F@_6, F@_7, F@_8,
						  F@_9, F@_10, TrUserData) ->
    d_field_blockchain_state_channel_v1_pb_nonce(Rest, Z1,
						 Z2, F@_1, F@_2, F@_3, F@_4,
						 F@_5, F@_6, F@_7, F@_8, F@_9,
						 F@_10, TrUserData);
...
dfp_read_field_def_blockchain_state_channel_v1_pb(<<58,
						  ...
						  F@_4, F@_5, F@_6, F@_7, F@_8,
						  F@_9, F@_10, TrUserData) ->
    d_field_blockchain_state_channel_v1_pb_skewed(Rest, Z1,
						  Z2, F@_1, F@_2, F@_3, F@_4,
						  F@_5, F@_6, F@_7, F@_8, F@_9,
						  F@_10, TrUserData);
dfp_read_field_def_blockchain_state_channel_v1_pb(<<64,
						  ...
						  F@_4, F@_5, F@_6, F@_7, F@_8,
						  F@_9, F@_10, TrUserData) ->
    d_field_blockchain_state_channel_v1_pb_state(Rest, Z1,
						 Z2, F@_1, F@_2, F@_3, F@_4,
						 F@_5, F@_6, F@_7, F@_8, F@_9,
						 F@_10, TrUserData);
...
dg_read_field_def_blockchain_state_channel_v1_pb(<<0:1,
    ...
    case Key of
      10 ->
	  d_field_blockchain_state_channel_v1_pb_id(Rest, 0, 0,
						    F@_1, F@_2, F@_3, F@_4,
						    F@_5, F@_6, F@_7, F@_8,
						    F@_9, F@_10, TrUserData);
      18 ->
	  d_field_blockchain_state_channel_v1_pb_owner(Rest, 0, 0,
						       F@_1, F@_2, F@_3, F@_4,
						       F@_5, F@_6, F@_7, F@_8,
						       F@_9, F@_10, TrUserData);
      24 ->
	  d_field_blockchain_state_channel_v1_pb_credits(Rest, 0,
							 0, F@_1, F@_2, F@_3,
							 F@_4, F@_5, F@_6, F@_7,
							 F@_8, F@_9, F@_10,
							 TrUserData);
      32 ->
	  d_field_blockchain_state_channel_v1_pb_nonce(Rest, 0, 0,
						       F@_1, F@_2, F@_3, F@_4,
						       F@_5, F@_6, F@_7, F@_8,
						       F@_9, F@_10, TrUserData);
      42 ->
	  ...
	  d_field_blockchain_state_channel_v1_pb_root_hash(Rest,
							   ...
							   TrUserData);
      58 ->
	  d_field_blockchain_state_channel_v1_pb_skewed(Rest, 0,
							0, F@_1, F@_2, F@_3,
							F@_4, F@_5, F@_6, F@_7,
							F@_8, F@_9, F@_10,
							TrUserData);
      64 ->
	  d_field_blockchain_state_channel_v1_pb_state(Rest, 0, 0,
						       F@_1, F@_2, F@_3, F@_4,
						       F@_5, F@_6, F@_7, F@_8,
						       F@_9, F@_10, TrUserData);
      72 ->
	  ...
	  case Key band 7 of
	    0 ->
		skip_varint_blockchain_state_channel_v1_pb(Rest, 0, 0,
							   F@_1, F@_2, F@_3,
							   F@_4, F@_5, F@_6,
							   F@_7, F@_8, F@_9,
							   F@_10, TrUserData);
	    1 ->
		skip_64_blockchain_state_channel_v1_pb(Rest, 0, 0, F@_1,
						       F@_2, F@_3, F@_4, F@_5,
						       F@_6, F@_7, F@_8, F@_9,
						       F@_10, TrUserData);
	    2 ->
		...
		skip_group_blockchain_state_channel_v1_pb(Rest,
							  ...
							  TrUserData);
	    5 ->
		skip_32_blockchain_state_channel_v1_pb(Rest, 0, 0, F@_1,
						       F@_2, F@_3, F@_4, F@_5,
						       F@_6, F@_7, F@_8, F@_9,
						       F@_10, TrUserData)
	  end
...
d_field_blockchain_state_channel_v1_pb_id(<<1:1, X:7,
					  ...
					  TrUserData)
    when N < 57 ->
    d_field_blockchain_state_channel_v1_pb_id(Rest, N + 7,
...
skip_varint_blockchain_state_channel_v1_pb(<<1:1, _:7,
					   ...
					   F@_6, F@_7, F@_8, F@_9, F@_10,
					   TrUserData) ->
    skip_varint_blockchain_state_channel_v1_pb(Rest, Z1, Z2,
					       F@_1, F@_2, F@_3, F@_4, F@_5,
					       F@_6, F@_7, F@_8, F@_9, F@_10,
					       TrUserData);
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_varint_blockchain_state_channel_response_v1_pb(Rest,
								    ...
								    TrUserData);
	    1 ->
		skip_64_blockchain_state_channel_response_v1_pb(Rest, 0,
								0, F@_1, F@_2,
								TrUserData);
	    2 ->
		...
		skip_group_blockchain_state_channel_response_v1_pb(Rest,
								   ...
								   TrUserData);
	    5 ->
		skip_32_blockchain_state_channel_response_v1_pb(Rest, 0,
								0, F@_1, F@_2,
								TrUserData)
	  end
    end;
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_varint_blockchain_state_channel_packet_v1_pb(Rest,
								  ...
								  TrUserData);
	    1 ->
		skip_64_blockchain_state_channel_packet_v1_pb(Rest, 0,
							      0, F@_1, F@_2,
							      F@_3, F@_4, F@_5,
							      TrUserData);
	    2 ->
		...
		skip_group_blockchain_state_channel_packet_v1_pb(Rest,
								 ...
								 TrUserData);
	    5 ->
		skip_32_blockchain_state_channel_packet_v1_pb(Rest, 0,
							      0, F@_1, F@_2,
							      F@_3, F@_4, F@_5,
							      TrUserData)
	  end
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_varint_blockchain_state_channel_offer_v1_pb(Rest,
								 ...
								 TrUserData);
	    1 ->
		skip_64_blockchain_state_channel_offer_v1_pb(Rest, 0, 0,
							     F@_1, F@_2, F@_3,
							     F@_4, F@_5, F@_6,
							     F@_7, F@_8,
							     TrUserData);
		...
		skip_group_blockchain_state_channel_offer_v1_pb(Rest,
								...
								TrUserData);
	    5 ->
		skip_32_blockchain_state_channel_offer_v1_pb(Rest, 0, 0,
							     F@_1, F@_2, F@_3,
							     F@_4, F@_5, F@_6,
							     F@_7, F@_8,
							     TrUserData)
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_varint_blockchain_state_channel_purchase_v1_pb(Rest,
								    ...
								    TrUserData);
	    1 ->
		skip_64_blockchain_state_channel_purchase_v1_pb(Rest, 0,
								0, F@_1, F@_2,
								F@_3, F@_4,
								F@_5,
								TrUserData);
		...
		skip_group_blockchain_state_channel_purchase_v1_pb(Rest,
								   ...
								   TrUserData);
	    5 ->
		skip_32_blockchain_state_channel_purchase_v1_pb(Rest, 0,
								0, F@_1, F@_2,
								F@_3, F@_4,
								F@_5,
								TrUserData)
...
dfp_read_field_def_blockchain_state_channel_diff_v1_pb(<<10,
							 Rest/binary>>,
						       Z1, Z2, F@_1, F@_2, F@_3,
						       F@_4, TrUserData) ->
    d_field_blockchain_state_channel_diff_v1_pb_id(Rest, Z1,
						   Z2, F@_1, F@_2, F@_3, F@_4,
						   TrUserData);
...
dg_read_field_def_blockchain_state_channel_diff_v1_pb(<<0:1,
    ...
    case Key of
      10 ->
	  d_field_blockchain_state_channel_diff_v1_pb_id(Rest, 0,
							 0, F@_1, F@_2, F@_3,
							 F@_4, TrUserData);
      16 ->
	  d_field_blockchain_state_channel_diff_v1_pb_add_nonce(Rest,
	  ...
	  case Key band 7 of
	    0 ->
		skip_varint_blockchain_state_channel_diff_v1_pb(Rest, 0,
								0, F@_1, F@_2,
								F@_3, F@_4,
								TrUserData);
	    1 ->
		skip_64_blockchain_state_channel_diff_v1_pb(Rest, 0, 0,
							    F@_1, F@_2, F@_3,
							    F@_4, TrUserData);
	    2 ->
		...
		skip_group_blockchain_state_channel_diff_v1_pb(Rest,
							       ...
							       TrUserData);
	    5 ->
		skip_32_blockchain_state_channel_diff_v1_pb(Rest, 0, 0,
							    F@_1, F@_2, F@_3,
							    F@_4, TrUserData)
	  end
    end;
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_varint_blockchain_state_channel_banner_v1_pb(Rest,
								  ...
								  TrUserData);
	    1 ->
		skip_64_blockchain_state_channel_banner_v1_pb(Rest, 0,
							      0, F@_1,
							      TrUserData);
	    2 ->
		...
		skip_group_blockchain_state_channel_banner_v1_pb(Rest,
								 ...
								 TrUserData);
	    5 ->
		skip_32_blockchain_state_channel_banner_v1_pb(Rest, 0,
							      0, F@_1,
							      TrUserData)
	  end
    end;
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_varint_blockchain_state_channel_message_v1_pb(Rest,
								   ...
								   TrUserData);
	    1 ->
		skip_64_blockchain_state_channel_message_v1_pb(Rest, 0,
							       0, F@_1,
							       TrUserData);
	    2 ->
		...
		skip_group_blockchain_state_channel_message_v1_pb(Rest,
								  ...
								  TrUserData);
	    5 ->
		skip_32_blockchain_state_channel_message_v1_pb(Rest, 0,
							       0, F@_1,
							       TrUserData)
	  end
    end;
...
dg_read_field_def_eui_pb(<<0:1, X:7, Rest/binary>>, N,
    ...
    case Key of
      8 ->
	  d_field_eui_pb_deveui(Rest, 0, 0, F@_1, F@_2,
				TrUserData);
      16 ->
	  d_field_eui_pb_appeui(Rest, 0, 0, F@_1, F@_2,
				TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
	    ...
	    2 ->
		skip_length_delimited_eui_pb(Rest, 0, 0, F@_1, F@_2,
					     TrUserData);
	    3 ->
		skip_group_eui_pb(Rest, Key bsr 3, 0, F@_1, F@_2,
				  TrUserData);
...
d_field_eui_pb_deveui(<<1:1, X:7, Rest/binary>>, N, Acc,
		      F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_eui_pb_deveui(Rest, N + 7, X bsl N + Acc, F@_1,
			  F@_2, TrUserData);
d_field_eui_pb_deveui(<<0:1, X:7, Rest/binary>>, N, Acc,
		      _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    dfp_read_field_def_eui_pb(RestF, 0, 0, NewFValue, F@_2,
			      TrUserData).

d_field_eui_pb_appeui(<<1:1, X:7, Rest/binary>>, N, Acc,
		      F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_eui_pb_appeui(Rest, N + 7, X bsl N + Acc, F@_1,
			  F@_2, TrUserData);
d_field_eui_pb_appeui(<<0:1, X:7, Rest/binary>>, N, Acc,
		      F@_1, _, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    dfp_read_field_def_eui_pb(RestF, 0, 0, F@_1, NewFValue,
			      TrUserData).

skip_varint_eui_pb(<<1:1, _:7, Rest/binary>>, Z1, Z2,
		   F@_1, F@_2, TrUserData) ->
    skip_varint_eui_pb(Rest, Z1, Z2, F@_1, F@_2,
		       TrUserData);
skip_varint_eui_pb(<<0:1, _:7, Rest/binary>>, Z1, Z2,
		   F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_eui_pb(Rest, Z1, Z2, F@_1, F@_2,
			      TrUserData).

skip_length_delimited_eui_pb(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_eui_pb(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, TrUserData);
skip_length_delimited_eui_pb(<<0:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_eui_pb(Rest2, 0, 0, F@_1, F@_2,
			      TrUserData).

skip_group_eui_pb(Bin, FNum, Z2, F@_1, F@_2,
		  TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_eui_pb(Rest, 0, Z2, F@_1, F@_2,
			      TrUserData).
...
decode_msg_routing_information_pb(Bin, TrUserData) ->
    dfp_read_field_def_routing_information_pb(Bin, 0, 0,
...
dfp_read_field_def_routing_information_pb(<<8,
					    Rest/binary>>,
					  Z1, Z2, F@_1, TrUserData) ->
    d_field_routing_information_pb_devaddr(Rest, Z1, Z2,
					   F@_1, TrUserData);
dfp_read_field_def_routing_information_pb(<<18,
					    Rest/binary>>,
					  Z1, Z2, F@_1, TrUserData) ->
    d_field_routing_information_pb_eui(Rest, Z1, Z2, F@_1,
				       TrUserData);
...
dfp_read_field_def_routing_information_pb(Other, Z1, Z2,
					  F@_1, TrUserData) ->
    dg_read_field_def_routing_information_pb(Other, Z1, Z2,
					     F@_1, TrUserData).
...
dg_read_field_def_routing_information_pb(<<1:1, X:7,
					 ...
					 N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_routing_information_pb(Rest, N + 7,
...
dg_read_field_def_routing_information_pb(<<0:1, X:7,
    ...
    case Key of
      8 ->
	  d_field_routing_information_pb_devaddr(Rest, 0, 0, F@_1,
						 TrUserData);
      18 ->
	  d_field_routing_information_pb_eui(Rest, 0, 0, F@_1,
					     TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_routing_information_pb(Rest, 0, 0, F@_1,
						   TrUserData);
	    1 ->
		skip_64_routing_information_pb(Rest, 0, 0, F@_1,
					       TrUserData);
	    2 ->
		skip_length_delimited_routing_information_pb(Rest, 0, 0,
							     F@_1, TrUserData);
	    3 ->
		skip_group_routing_information_pb(Rest, Key bsr 3, 0,
						  F@_1, TrUserData);
	    5 ->
		skip_32_routing_information_pb(Rest, 0, 0, F@_1,
					       TrUserData)
	  end
    end;
...
d_field_routing_information_pb_devaddr(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_routing_information_pb_devaddr(Rest, N + 7,
					   X bsl N + Acc, F@_1, TrUserData);
d_field_routing_information_pb_devaddr(<<0:1, X:7,
    ...
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    dfp_read_field_def_routing_information_pb(RestF, 0, 0,
...
d_field_routing_information_pb_eui(<<1:1, X:7,
				   ...
				   N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_routing_information_pb_eui(Rest, N + 7,
				       X bsl N + Acc, F@_1, TrUserData);
...
skip_varint_routing_information_pb(<<1:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, TrUserData) ->
    skip_varint_routing_information_pb(Rest, Z1, Z2, F@_1,
				       TrUserData);
skip_varint_routing_information_pb(<<0:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_routing_information_pb(Rest, Z1, Z2,
					      F@_1, TrUserData).
...
skip_length_delimited_routing_information_pb(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_routing_information_pb(Rest2, 0, 0,
					      F@_1, TrUserData).

skip_group_routing_information_pb(Bin, FNum, Z2, F@_1,
				  TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_routing_information_pb(Rest, 0, Z2,
					      F@_1, TrUserData).
...
dfp_read_field_def_window_pb(Other, Z1, Z2, F@_1, F@_2,
			     F@_3, TrUserData) ->
    dg_read_field_def_window_pb(Other, Z1, Z2, F@_1, F@_2,
				F@_3, TrUserData).

dg_read_field_def_window_pb(<<1:1, X:7, Rest/binary>>,
			    N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_window_pb(Rest, N + 7, X bsl N + Acc,
				F@_1, F@_2, F@_3, TrUserData);
dg_read_field_def_window_pb(<<0:1, X:7, Rest/binary>>,
    ...
    case Key of
      8 ->
	  d_field_window_pb_timestamp(Rest, 0, 0, F@_1, F@_2,
				      F@_3, TrUserData);
      21 ->
	  d_field_window_pb_frequency(Rest, 0, 0, F@_1, F@_2,
				      F@_3, TrUserData);
      26 ->
	  d_field_window_pb_datarate(Rest, 0, 0, F@_1, F@_2, F@_3,
				     TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_window_pb(Rest, 0, 0, F@_1, F@_2, F@_3,
				      TrUserData);
	    1 ->
		skip_64_window_pb(Rest, 0, 0, F@_1, F@_2, F@_3,
				  TrUserData);
	    2 ->
		skip_length_delimited_window_pb(Rest, 0, 0, F@_1, F@_2,
						F@_3, TrUserData);
	    3 ->
		skip_group_window_pb(Rest, Key bsr 3, 0, F@_1, F@_2,
				     F@_3, TrUserData);
	    5 ->
		skip_32_window_pb(Rest, 0, 0, F@_1, F@_2, F@_3,
				  TrUserData)
	  end
    end;
...
d_field_window_pb_timestamp(<<1:1, X:7, Rest/binary>>,
			    N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_window_pb_timestamp(Rest, N + 7, X bsl N + Acc,
				F@_1, F@_2, F@_3, TrUserData);
d_field_window_pb_timestamp(<<0:1, X:7, Rest/binary>>,
			    N, Acc, _, F@_2, F@_3, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    dfp_read_field_def_window_pb(RestF, 0, 0, NewFValue,
				 F@_2, F@_3, TrUserData).

d_field_window_pb_frequency(<<0:16, 128, 127,
			      Rest/binary>>,
			    Z1, Z2, F@_1, _, F@_3, TrUserData) ->
    dfp_read_field_def_window_pb(Rest, Z1, Z2, F@_1,
...
d_field_window_pb_datarate(<<1:1, X:7, Rest/binary>>, N,
    ...
    when N < 57 ->
    d_field_window_pb_datarate(Rest, N + 7, X bsl N + Acc,
			       F@_1, F@_2, F@_3, TrUserData);
d_field_window_pb_datarate(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_window_pb(RestF, 0, 0, F@_1, F@_2,
				 NewFValue, TrUserData).

skip_varint_window_pb(<<1:1, _:7, Rest/binary>>, Z1, Z2,
		      F@_1, F@_2, F@_3, TrUserData) ->
    skip_varint_window_pb(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			  TrUserData);
skip_varint_window_pb(<<0:1, _:7, Rest/binary>>, Z1, Z2,
		      F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_window_pb(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, TrUserData).
...
skip_length_delimited_window_pb(<<1:1, X:7,
				...
				N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    skip_length_delimited_window_pb(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, F@_3,
				    TrUserData);
skip_length_delimited_window_pb(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_window_pb(Rest2, 0, 0, F@_1, F@_2,
				 F@_3, TrUserData).

skip_group_window_pb(Bin, FNum, Z2, F@_1, F@_2, F@_3,
		     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_window_pb(Rest, 0, Z2, F@_1, F@_2,
				 F@_3, TrUserData).
...
decode_msg_packet_pb(Bin, TrUserData) ->
    dfp_read_field_def_packet_pb(Bin, 0, 0,
				 id(0, TrUserData), id(longfi, TrUserData),
				 id(<<>>, TrUserData), id(0, TrUserData),
				 id(0.0, TrUserData), id(0.0, TrUserData),
				 id([], TrUserData), id(0.0, TrUserData),
				 id(undefined, TrUserData),
...
dfp_read_field_def_packet_pb(<<8, Rest/binary>>, Z1, Z2,
			     ...
			     F@_9, F@_10, TrUserData) ->
    d_field_packet_pb_oui(Rest, Z1, Z2, F@_1, F@_2, F@_3,
...
dfp_read_field_def_packet_pb(Other, Z1, Z2, F@_1, F@_2,
			     F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
			     TrUserData) ->
    dg_read_field_def_packet_pb(Other, Z1, Z2, F@_1, F@_2,
				F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
				TrUserData).
...
dg_read_field_def_packet_pb(<<1:1, X:7, Rest/binary>>,
    ...
    when N < 32 - 7 ->
    dg_read_field_def_packet_pb(Rest, N + 7, X bsl N + Acc,
				F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
				F@_9, F@_10, TrUserData);
dg_read_field_def_packet_pb(<<0:1, X:7, Rest/binary>>,
    ...
    case Key of
      8 ->
	  d_field_packet_pb_oui(Rest, 0, 0, F@_1, F@_2, F@_3,
				F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
				TrUserData);
      16 ->
	  d_field_packet_pb_type(Rest, 0, 0, F@_1, F@_2, F@_3,
				 F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
				 TrUserData);
      26 ->
	  d_field_packet_pb_payload(Rest, 0, 0, F@_1, F@_2, F@_3,
				    F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
				    TrUserData);
      32 ->
	  d_field_packet_pb_timestamp(Rest, 0, 0, F@_1, F@_2,
				      F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
				      F@_10, TrUserData);
      45 ->
	  d_field_packet_pb_signal_strength(Rest, 0, 0, F@_1,
					    F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
					    F@_8, F@_9, F@_10, TrUserData);
      53 ->
	  d_field_packet_pb_frequency(Rest, 0, 0, F@_1, F@_2,
				      F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
				      F@_10, TrUserData);
      58 ->
	  d_field_packet_pb_datarate(Rest, 0, 0, F@_1, F@_2, F@_3,
				     F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
				     TrUserData);
      69 ->
	  d_field_packet_pb_snr(Rest, 0, 0, F@_1, F@_2, F@_3,
				F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
				TrUserData);
      74 ->
	  d_field_packet_pb_routing(Rest, 0, 0, F@_1, F@_2, F@_3,
				    F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
				    TrUserData);
      82 ->
	  d_field_packet_pb_rx2_window(Rest, 0, 0, F@_1, F@_2,
				       F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
				       F@_10, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_packet_pb(Rest, 0, 0, F@_1, F@_2, F@_3,
				      F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
				      TrUserData);
	    1 ->
		skip_64_packet_pb(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
				  F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
				  TrUserData);
	    2 ->
		skip_length_delimited_packet_pb(Rest, 0, 0, F@_1, F@_2,
						F@_3, F@_4, F@_5, F@_6, F@_7,
						F@_8, F@_9, F@_10, TrUserData);
	    3 ->
		skip_group_packet_pb(Rest, Key bsr 3, 0, F@_1, F@_2,
				     F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
				     F@_10, TrUserData);
	    5 ->
		skip_32_packet_pb(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
				  F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
				  TrUserData)
	  end
    end;
...
d_field_packet_pb_oui(<<1:1, X:7, Rest/binary>>, N, Acc,
		      ...
		      F@_10, TrUserData)
    when N < 57 ->
    d_field_packet_pb_oui(Rest, N + 7, X bsl N + Acc, F@_1,
...
d_field_packet_pb_oui(<<0:1, X:7, Rest/binary>>, N, Acc,
    ...
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    dfp_read_field_def_packet_pb(RestF, 0, 0, NewFValue,
...
d_field_packet_pb_type(<<1:1, X:7, Rest/binary>>, N,
		       ...
		       F@_9, F@_10, TrUserData)
    when N < 57 ->
    d_field_packet_pb_type(Rest, N + 7, X bsl N + Acc, F@_1,
			   F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
			   F@_10, TrUserData);
d_field_packet_pb_type(<<0:1, X:7, Rest/binary>>, N,
	...
	{id('d_enum_packet_pb.packet_type'(begin
	    ...
	    TrUserData),
	 Rest},
    dfp_read_field_def_packet_pb(RestF, 0, 0, F@_1,
...
d_field_packet_pb_payload(<<1:1, X:7, Rest/binary>>, N,
			  ...
			  F@_9, F@_10, TrUserData)
    when N < 57 ->
    d_field_packet_pb_payload(Rest, N + 7, X bsl N + Acc,
			      F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
			      F@_9, F@_10, TrUserData);
d_field_packet_pb_payload(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_packet_pb(RestF, 0, 0, F@_1, F@_2,
...
d_field_packet_pb_timestamp(<<1:1, X:7, Rest/binary>>,
			    ...
			    F@_8, F@_9, F@_10, TrUserData)
    when N < 57 ->
    d_field_packet_pb_timestamp(Rest, N + 7, X bsl N + Acc,
				F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
				F@_9, F@_10, TrUserData);
...
d_field_packet_pb_signal_strength(<<0:16, 128, 127,
				  ...
				  F@_8, F@_9, F@_10, TrUserData) ->
    dfp_read_field_def_packet_pb(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, id(infinity, TrUserData), F@_6,
...
d_field_packet_pb_signal_strength(<<_:16, 1:1, _:7, _:1,
				  ...
				  F@_8, F@_9, F@_10, TrUserData) ->
    dfp_read_field_def_packet_pb(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, id(nan, TrUserData), F@_6, F@_7,
				 F@_8, F@_9, F@_10, TrUserData);
d_field_packet_pb_signal_strength(<<Value:32/little-float,
				  ...
				  F@_8, F@_9, F@_10, TrUserData) ->
    dfp_read_field_def_packet_pb(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, id(Value, TrUserData), F@_6, F@_7,
				 F@_8, F@_9, F@_10, TrUserData).
...
d_field_packet_pb_datarate(<<1:1, X:7, Rest/binary>>, N,
			   ...
			   F@_9, F@_10, TrUserData)
    when N < 57 ->
    d_field_packet_pb_datarate(Rest, N + 7, X bsl N + Acc,
			       F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
			       F@_9, F@_10, TrUserData);
...
d_field_packet_pb_snr(<<Value:32/little-float,
    ...
    dfp_read_field_def_packet_pb(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, F@_5, F@_6, F@_7,
				 id(Value, TrUserData), F@_9, F@_10,
				 TrUserData).
...
d_field_packet_pb_routing(<<1:1, X:7, Rest/binary>>, N,
			  ...
			  F@_9, F@_10, TrUserData)
    when N < 57 ->
    d_field_packet_pb_routing(Rest, N + 7, X bsl N + Acc,
			      F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
			      F@_9, F@_10, TrUserData);
...
d_field_packet_pb_rx2_window(<<1:1, X:7, Rest/binary>>,
			     ...
			     F@_8, F@_9, F@_10, TrUserData)
    when N < 57 ->
    d_field_packet_pb_rx2_window(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
				 F@_9, F@_10, TrUserData);
d_field_packet_pb_rx2_window(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_packet_pb(RestF, 0, 0, F@_1, F@_2,
				 ...
				 if Prev == undefined -> NewFValue;
				    true ->
					merge_msg_window_pb(Prev, NewFValue,
							    TrUserData)
				 end,
				 TrUserData).
...
skip_varint_packet_pb(<<1:1, _:7, Rest/binary>>, Z1, Z2,
		      F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
		      F@_10, TrUserData) ->
    skip_varint_packet_pb(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			  F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
			  TrUserData);
...
skip_length_delimited_packet_pb(<<1:1, X:7,
				...
				F@_7, F@_8, F@_9, F@_10, TrUserData)
    when N < 57 ->
    skip_length_delimited_packet_pb(Rest, N + 7,
...
skip_length_delimited_packet_pb(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_packet_pb(Rest2, 0, 0, F@_1, F@_2,
				 F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
				 F@_10, TrUserData).
...
skip_group_packet_pb(Bin, FNum, Z2, F@_1, F@_2, F@_3,
		     ...
		     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_packet_pb(Rest, 0, Z2, F@_1, F@_2,
				 F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
				 F@_10, TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
	  ...
	  merge_msg_blockchain_state_channel_summary_v1_pb(Prev,
							   New, TrUserData);
      blockchain_state_channel_v1_pb ->
	  merge_msg_blockchain_state_channel_v1_pb(Prev, New,
						   TrUserData);
      blockchain_state_channel_response_v1_pb ->
	  ...
	  merge_msg_blockchain_state_channel_purchase_v1_pb(Prev,
							    New, TrUserData);
      blockchain_state_channel_diff_v1_pb ->
	  merge_msg_blockchain_state_channel_diff_v1_pb(Prev, New,
							TrUserData);
      blockchain_state_channel_diff_entry_v1_pb ->
    ...
    #routing_information_pb{data =
				case {PFdata, NFdata} of
				  {{eui, OPFdata}, {eui, ONFdata}} ->
				      {eui,
				       merge_msg_eui_pb(OPFdata, ONFdata,
							TrUserData)};
				  {_, undefined} -> PFdata;
				  _ -> NFdata
				end}.
...
merge_msg_packet_pb(#packet_pb{oui = PFoui,
    ...
    #packet_pb{oui =
		   ...
		   if PFrouting /= undefined, NFrouting /= undefined ->
			  merge_msg_routing_information_pb(PFrouting, NFrouting,
							   TrUserData);
		   ...
		   if PFrx2_window /= undefined,
			  ...
			  merge_msg_window_pb(PFrx2_window, NFrx2_window,
					      TrUserData);
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
	  ...
	  v_msg_blockchain_state_channel_summary_v1_pb(Msg,
						       [MsgName], TrUserData);
      blockchain_state_channel_v1_pb ->
	  v_msg_blockchain_state_channel_v1_pb(Msg, [MsgName],
					       TrUserData);
      blockchain_state_channel_response_v1_pb ->
      ...
      routing_information_pb ->
	  v_msg_routing_information_pb(Msg, [MsgName],
				       TrUserData);
      window_pb ->
...
v_msg_blockchain_state_channel_offer_v1_pb(#blockchain_state_channel_offer_v1_pb{routing
    ...
    if F1 == undefined -> ok;
       true ->
	   v_msg_routing_information_pb(F1, [routing | Path],
					TrUserData)
    end,
    if F2 == undefined -> ok;
       true ->
...
v_msg_blockchain_state_channel_purchase_v1_pb(#blockchain_state_channel_purchase_v1_pb{sc
    ...
    if F1 == undefined -> ok;
       true ->
	   v_msg_blockchain_state_channel_v1_pb(F1, [sc | Path],
						TrUserData)
    end,
    if F2 == undefined -> ok;
       true -> v_type_bytes(F2, [hotspot | Path], TrUserData)
...
v_msg_routing_information_pb(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, routing_information_pb}, X,
		  Path).
...
v_msg_packet_pb(#packet_pb{oui = F1, type = F2,
    ...
    if F2 == undefined -> ok;
       true ->
	   'v_enum_packet_pb.packet_type'(F2, [type | Path],
					  TrUserData)
    end,
    if F3 == undefined -> ok;
    ...
    if F9 == undefined -> ok;
       true ->
	   v_msg_routing_information_pb(F9, [routing | Path],
					TrUserData)
    end,
    if F10 == undefined -> ok;
       true ->
...
get_msg_defs() ->
    [{{enum, 'helium.blockchain_state_channel_state_v1'},
     ...
     {{enum, 'packet_pb.packet_type'},
      [{longfi, 0}, {lorawan, 1}]},
     {{enum, 'helium.region'},
      [{'US915', 0}, {'EU868', 1}, {'EU433', 2}, {'CN470', 3},
       {'CN779', 4}, {'AU915', 5}, {'AS923_1', 6},
       {'KR920', 7}, {'IN865', 8}, {'AS923_2', 9},
       {'AS923_3', 10}, {'AS923_4', 11}]},
     {{msg, blockchain_state_channel_summary_v1_pb},
      [[{name, client_pubkeybin}, {fnum, 1}, {rnum, 2},
	{type, bytes}, {occurrence, optional}, {opts, []}],
       [{name, num_packets}, {fnum, 2}, {rnum, 3},
	{type, uint64}, {occurrence, optional}, {opts, []}],
       [{name, num_dcs}, {fnum, 3}, {rnum, 4}, {type, uint64},
	{occurrence, optional}, {opts, []}]]},
     {{msg, blockchain_state_channel_v1_pb},
      [[{name, id}, {fnum, 1}, {rnum, 2}, {type, bytes},
	{occurrence, optional}, {opts, []}],
       [{name, owner}, {fnum, 2}, {rnum, 3}, {type, bytes},
	{occurrence, optional}, {opts, []}],
       [{name, credits}, {fnum, 3}, {rnum, 4}, {type, uint64},
	{occurrence, optional}, {opts, []}],
       [{name, nonce}, {fnum, 4}, {rnum, 5}, {type, uint64},
	{occurrence, optional}, {opts, []}],
       [{name, summaries}, {fnum, 5}, {rnum, 6},
	{type, {msg, blockchain_state_channel_summary_v1_pb}},
	{occurrence, repeated}, {opts, []}],
       [{name, root_hash}, {fnum, 6}, {rnum, 7}, {type, bytes},
	{occurrence, optional}, {opts, []}],
       [{name, skewed}, {fnum, 7}, {rnum, 8}, {type, bytes},
	{occurrence, optional}, {opts, []}],
       [{name, state}, {fnum, 8}, {rnum, 9},
	{type,
	 {enum, 'helium.blockchain_state_channel_state_v1'}},
	{occurrence, optional}, {opts, []}],
       [{name, expire_at_block}, {fnum, 9}, {rnum, 10},
	{type, uint64}, {occurrence, optional}, {opts, []}],
       [{name, signature}, {fnum, 10}, {rnum, 11},
	{type, bytes}, {occurrence, optional}, {opts, []}]]},
     {{msg, blockchain_state_channel_response_v1_pb},
      [[{name, accepted}, {fnum, 1}, {rnum, 2}, {type, bool},
	{occurrence, optional}, {opts, []}],
       [{name, downlink}, {fnum, 4}, {rnum, 3},
	{type, {msg, packet_pb}}, {occurrence, optional},
	{opts, []}]]},
     {{msg, blockchain_state_channel_packet_v1_pb},
      [[{name, packet}, {fnum, 1}, {rnum, 2},
	{type, {msg, packet_pb}}, {occurrence, optional},
	{opts, []}],
       [{name, hotspot}, {fnum, 2}, {rnum, 3}, {type, bytes},
	{occurrence, optional}, {opts, []}],
       [{name, signature}, {fnum, 3}, {rnum, 4}, {type, bytes},
	{occurrence, optional}, {opts, []}],
       [{name, region}, {fnum, 4}, {rnum, 5},
	{type, {enum, 'helium.region'}}, {occurrence, optional},
	{opts, []}],
       [{name, hold_time}, {fnum, 5}, {rnum, 6},
	{type, uint64}, {occurrence, optional}, {opts, []}]]},
     {{msg, blockchain_state_channel_offer_v1_pb},
      [[{name, routing}, {fnum, 1}, {rnum, 2},
	{type, {msg, routing_information_pb}},
	{occurrence, optional}, {opts, []}],
       [{name, packet_hash}, {fnum, 2}, {rnum, 3},
	{type, bytes}, {occurrence, optional}, {opts, []}],
       [{name, payload_size}, {fnum, 3}, {rnum, 4},
	{type, uint64}, {occurrence, optional}, {opts, []}],
       [{name, fcnt}, {fnum, 4}, {rnum, 5}, {type, uint32},
	{occurrence, optional}, {opts, []}],
       [{name, hotspot}, {fnum, 5}, {rnum, 6}, {type, bytes},
	{occurrence, optional}, {opts, []}],
       [{name, signature}, {fnum, 6}, {rnum, 7}, {type, bytes},
	{occurrence, optional}, {opts, []}],
       [{name, region}, {fnum, 7}, {rnum, 8},
	{type, {enum, 'helium.region'}}, {occurrence, optional},
	{opts, []}],
       [{name, req_diff}, {fnum, 8}, {rnum, 9}, {type, bool},
	{occurrence, optional}, {opts, []}]]},
     {{msg, blockchain_state_channel_purchase_v1_pb},
      [[{name, sc}, {fnum, 1}, {rnum, 2},
	{type, {msg, blockchain_state_channel_v1_pb}},
	{occurrence, optional}, {opts, []}],
       [{name, hotspot}, {fnum, 2}, {rnum, 3}, {type, bytes},
	{occurrence, optional}, {opts, []}],
       [{name, packet_hash}, {fnum, 3}, {rnum, 4},
	{type, bytes}, {occurrence, optional}, {opts, []}],
       [{name, region}, {fnum, 4}, {rnum, 5},
	{type, {enum, 'helium.region'}}, {occurrence, optional},
	{opts, []}],
       [{name, sc_diff}, {fnum, 5}, {rnum, 6},
	{type, {msg, blockchain_state_channel_diff_v1_pb}},
	{occurrence, optional}, {opts, []}]]},
     {{msg, blockchain_state_channel_diff_v1_pb},
      [[{name, id}, {fnum, 1}, {rnum, 2}, {type, bytes},
	{occurrence, optional}, {opts, []}],
       [{name, add_nonce}, {fnum, 2}, {rnum, 3},
	{type, uint64}, {occurrence, optional}, {opts, []}],
       [{name, signature}, {fnum, 3}, {rnum, 4}, {type, bytes},
	{occurrence, optional}, {opts, []}],
       [{name, diffs}, {fnum, 4}, {rnum, 5},
	{type,
	 {msg, blockchain_state_channel_diff_entry_v1_pb}},
	{occurrence, repeated}, {opts, []}]]},
     {{msg, blockchain_state_channel_diff_entry_v1_pb},
      [[{name, entry}, {rnum, 2},
	{fields,
	 [[{name, append}, {fnum, 1}, {rnum, 2},
	   {type,
	    {msg,
	     blockchain_state_channel_diff_append_summary_v1_pb}},
	   {occurrence, optional}, {opts, []}],
	  [{name, add}, {fnum, 2}, {rnum, 2},
	   {type,
	    {msg,
	     blockchain_state_channel_diff_update_summary_v1_pb}},
	   {occurrence, optional}, {opts, []}]]}]]},
	...
	{occurrence, optional}, {opts, []}]]},
     {{msg,
       blockchain_state_channel_diff_update_summary_v1_pb},
      [[{name, client_index}, {fnum, 1}, {rnum, 2},
	{type, uint64}, {occurrence, optional}, {opts, []}],
       [{name, add_packets}, {fnum, 2}, {rnum, 3},
	{type, uint64}, {occurrence, optional}, {opts, []}],
       [{name, add_dcs}, {fnum, 3}, {rnum, 4}, {type, uint64},
	{occurrence, optional}, {opts, []}]]},
	...
	{occurrence, optional}, {opts, []}]]},
     {{msg, blockchain_state_channel_rejection_v1_pb},
      [[{name, reject}, {fnum, 1}, {rnum, 2}, {type, uint32},
	{occurrence, optional}, {opts, []}],
       [{name, packet_hash}, {fnum, 2}, {rnum, 3},
	{type, bytes}, {occurrence, optional}, {opts, []}]]},
     {{msg, blockchain_state_channel_message_v1_pb},
      [[{name, msg}, {rnum, 2},
	{fields,
	 [[{name, response}, {fnum, 2}, {rnum, 2},
	   {type, {msg, blockchain_state_channel_response_v1_pb}},
	   {occurrence, optional}, {opts, []}],
	  [{name, packet}, {fnum, 4}, {rnum, 2},
	   {type, {msg, blockchain_state_channel_packet_v1_pb}},
	   {occurrence, optional}, {opts, []}],
	  [{name, offer}, {fnum, 5}, {rnum, 2},
	   {type, {msg, blockchain_state_channel_offer_v1_pb}},
	   {occurrence, optional}, {opts, []}],
	  [{name, purchase}, {fnum, 6}, {rnum, 2},
	   {type, {msg, blockchain_state_channel_purchase_v1_pb}},
	   {occurrence, optional}, {opts, []}],
	  [{name, banner}, {fnum, 7}, {rnum, 2},
	   {type, {msg, blockchain_state_channel_banner_v1_pb}},
	   {occurrence, optional}, {opts, []}],
	  [{name, reject}, {fnum, 8}, {rnum, 2},
	   {type, {msg, blockchain_state_channel_rejection_v1_pb}},
	   {occurrence, optional}, {opts, []}]]}]]},
     {{msg, eui_pb},
      [[{name, deveui}, {fnum, 1}, {rnum, 2}, {type, uint64},
	{occurrence, optional}, {opts, []}],
       [{name, appeui}, {fnum, 2}, {rnum, 3}, {type, uint64},
	{occurrence, optional}, {opts, []}]]},
     {{msg, routing_information_pb},
      [[{name, data}, {rnum, 2},
	{fields,
	 [[{name, devaddr}, {fnum, 1}, {rnum, 2}, {type, uint32},
	   {occurrence, optional}, {opts, []}],
	  [{name, eui}, {fnum, 2}, {rnum, 2},
	   {type, {msg, eui_pb}}, {occurrence, optional},
	   {opts, []}]]}]]},
     {{msg, window_pb},
      [[{name, timestamp}, {fnum, 1}, {rnum, 2},
	{type, uint64}, {occurrence, optional}, {opts, []}],
       [{name, frequency}, {fnum, 2}, {rnum, 3}, {type, float},
	{occurrence, optional}, {opts, []}],
       [{name, datarate}, {fnum, 3}, {rnum, 4}, {type, string},
	{occurrence, optional}, {opts, []}]]},
     {{msg, packet_pb},
      [[{name, oui}, {fnum, 1}, {rnum, 2}, {type, uint32},
	{occurrence, optional}, {opts, []}],
       [{name, type}, {fnum, 2}, {rnum, 3},
	{type, {enum, 'packet_pb.packet_type'}},
	{occurrence, optional}, {opts, []}],
       [{name, payload}, {fnum, 3}, {rnum, 4}, {type, bytes},
	{occurrence, optional}, {opts, []}],
       [{name, timestamp}, {fnum, 4}, {rnum, 5},
	{type, uint64}, {occurrence, optional}, {opts, []}],
       [{name, signal_strength}, {fnum, 5}, {rnum, 6},
	{type, float}, {occurrence, optional}, {opts, []}],
       [{name, frequency}, {fnum, 6}, {rnum, 7}, {type, float},
	{occurrence, optional}, {opts, []}],
       [{name, datarate}, {fnum, 7}, {rnum, 8}, {type, string},
	{occurrence, optional}, {opts, []}],
       [{name, snr}, {fnum, 8}, {rnum, 9}, {type, float},
	{occurrence, optional}, {opts, []}],
       [{name, routing}, {fnum, 9}, {rnum, 10},
	{type, {msg, routing_information_pb}},
	{occurrence, optional}, {opts, []}],
       [{name, rx2_window}, {fnum, 10}, {rnum, 11},
	{type, {msg, window_pb}}, {occurrence, optional},
	{opts, []}]]}].
...
get_msg_names() ->
    [blockchain_state_channel_summary_v1_pb,
     ...
     blockchain_state_channel_banner_v1_pb,
     blockchain_state_channel_rejection_v1_pb,
     blockchain_state_channel_message_v1_pb, eui_pb,
     routing_information_pb, window_pb, packet_pb].
...
get_enum_names() ->
    ['helium.blockchain_state_channel_state_v1',
     'packet_pb.packet_type', 'helium.region'].
...
get_service_names() -> ['helium.state_channel'].


get_service_def('helium.state_channel') ->
    {{service, 'helium.state_channel'},
     [[{name, msg},
...
get_rpc_names('helium.state_channel') -> [msg];
get_rpc_names(_) -> error.


find_rpc_def('helium.state_channel', RpcName) ->
    'find_rpc_def_helium.state_channel'(RpcName);
find_rpc_def(_, _) -> error.


'find_rpc_def_helium.state_channel'(msg) ->
    [{name, msg},
     {input, blockchain_state_channel_message_v1_pb},
     {output, blockchain_state_channel_message_v1_pb},
     {input_stream, true}, {output_stream, true},
     {opts, []}];
'find_rpc_def_helium.state_channel'(_) -> error.
...
fqbin_to_service_name(<<"helium.state_channel">>) ->
...
service_name_to_fqbin('helium.state_channel') ->
    <<"helium.state_channel">>;
...
%% name, as atoms.
fqbins_to_service_and_rpc_name(<<"helium.state_channel">>, <<"msg">>) ->
...
service_and_rpc_name_to_fqbins('helium.state_channel',
			       msg) ->
    {<<"helium.state_channel">>, <<"msg">>};
...
source_basename() -> "state_channel.proto".
...
get_all_source_basenames() ->
    ["state_channel.proto",
     "blockchain_state_channel_v1.proto", "packet.proto",
     "region.proto"].
...
%% functions.
get_all_proto_names() ->
    ["state_channel", "blockchain_state_channel_v1",
     "packet", "region"].


get_msg_containment("state_channel") -> [];
...
get_pkg_containment("state_channel") -> helium;
...
get_service_containment("state_channel") ->
    ['helium.state_channel'];
...
get_rpc_containment("state_channel") ->
    [{'helium.state_channel', msg}];
...
get_proto_by_service_name_as_fqbin(<<"helium.state_channel">>) ->
    "state_channel";
...
get_proto_by_enum_name_as_fqbin(<<"helium.region">>) -> "region";
get_proto_by_enum_name_as_fqbin(E) ->
    error({gpb_error, {badenum, E}}).


get_protos_by_pkg_name_as_fqbin(<<"helium">>) ->
    ["blockchain_state_channel_v1", "packet", "region",
     "state_channel"];
