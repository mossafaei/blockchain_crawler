...
-ifndef(state_channel_pb).
-define(state_channel_pb, true).

-define(state_channel_pb_gpb_version, "4.11.2").
...
-record(blockchain_state_channel_v1_pb,
        {id = <<>>              :: iodata() | undefined, % = 1
         ...
         summaries = []         :: [state_channel_pb:blockchain_state_channel_summary_v1_pb()] | undefined, % = 5
...
-record(blockchain_state_channel_response_v1_pb,
        {accepted = false       :: boolean() | 0 | 1 | undefined, % = 1
         downlink = undefined   :: state_channel_pb:packet_pb() | undefined % = 4
        }).
-endif.
...
-record(blockchain_state_channel_packet_v1_pb,
        {packet = undefined     :: state_channel_pb:packet_pb() | undefined, % = 1
...
-record(blockchain_state_channel_offer_v1_pb,
        {routing = undefined    :: state_channel_pb:routing_information_pb() | undefined, % = 1
...
-record(blockchain_state_channel_purchase_v1_pb,
        {sc = undefined         :: state_channel_pb:blockchain_state_channel_v1_pb() | undefined, % = 1
         hotspot = <<>>         :: iodata() | undefined, % = 2
         packet_hash = <<>>     :: iodata() | undefined, % = 3
         region = 'US915'       :: 'US915' | 'EU868' | 'EU433' | 'CN470' | 'CN779' | 'AU915' | 'AS923_1' | 'KR920' | 'IN865' | 'AS923_2' | 'AS923_3' | 'AS923_4' | integer() | undefined, % = 4, enum helium.region
         sc_diff = undefined    :: state_channel_pb:blockchain_state_channel_diff_v1_pb() | undefined % = 5
        }).
-endif.
...
-record(blockchain_state_channel_diff_v1_pb,
        {id = <<>>              :: iodata() | undefined, % = 1
         ...
         signature = <<>>       :: iodata() | undefined, % = 3
         diffs = []             :: [state_channel_pb:blockchain_state_channel_diff_entry_v1_pb()] | undefined % = 4
        }).
-endif.
...
-record(blockchain_state_channel_diff_entry_v1_pb,
        {entry                  :: {append, state_channel_pb:blockchain_state_channel_diff_append_summary_v1_pb()} | {add, state_channel_pb:blockchain_state_channel_diff_update_summary_v1_pb()} | undefined % oneof
        }).
-endif.
...
-record(blockchain_state_channel_message_v1_pb,
        {msg                    :: {response, state_channel_pb:blockchain_state_channel_response_v1_pb()} | {packet, state_channel_pb:blockchain_state_channel_packet_v1_pb()} | {offer, state_channel_pb:blockchain_state_channel_offer_v1_pb()} | {purchase, state_channel_pb:blockchain_state_channel_purchase_v1_pb()} | {banner, state_channel_pb:blockchain_state_channel_banner_v1_pb()} | {reject, state_channel_pb:blockchain_state_channel_rejection_v1_pb()} | undefined % oneof
        }).
-endif.
...
-record(routing_information_pb,
        {data                   :: {devaddr, non_neg_integer()} | {eui, state_channel_pb:eui_pb()} | undefined % oneof
        }).
-endif.
...
-record(packet_pb,
        {oui = 0                :: non_neg_integer() | undefined, % = 1, 32 bits
         ...
         routing = undefined    :: state_channel_pb:routing_information_pb() | undefined, % = 9
         rx2_window = undefined :: state_channel_pb:window_pb() | undefined % = 10
        }).
-endif.
